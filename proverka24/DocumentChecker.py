...
def local_to_absolute_path(file_path):
    base_path = r'G:\Python\urfu_LLM_documents\proverka24'
...
def delete_file_in_folder():
    folders_to_delete = [
        ...
        local_to_absolute_path('data/pdf_images')
    ]
...
def main():
    ...
    pdf_path = r'G:\Python\urfu_LLM_documents\proverka24\data\Кунашак, КРК, оп 1, п.хр. (3).pdf'  
